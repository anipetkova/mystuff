...
logreg = RandomForestClassifier(n_estimators=50, max_features="auto", random_state=6)
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.3, random_state=best)#9035, 7738, 1649,
logreg.fit(X_train,y_train)
