# -*- coding: utf-8 -*-
"""
Created on Mon Dec 11 14:06:14 2023
...
logreg = RandomForestClassifier(n_estimators=50, max_features="auto", random_state=6)#6


from sklearn.model_selection import train_test_split 
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.3, random_state=7738) #7738
