# -*- coding: utf-8 -*-
"""
Created on Mon Nov 27 17:58:43 2023
...
#logreg = RandomForestClassifier(n_estimators=80,max_depth=10,random_state=210,class_weight='balanced')
logreg=RandomForestClassifier(n_estimators=100, max_depth=9, random_state=422)
# Nov 2023
#mGM= 61.12059005577164
#CBA=  59.02547065337763

from sklearn.model_selection import KFold
kf = KFold(n_splits=12, shuffle = True, random_state = 70)# random_state = 70 mGM= 59.41 CBA=  58.18
k=0
sm=0
