# -*- coding: utf-8 -*-
"""
Created on Mon Nov 27 14:07:09 2023
...
dataset = pd.read_csv("contraceptive.dat", delimiter = ',', header=None, skiprows = 14)
...
kf = KFold(n_splits=15, shuffle = True, random_state = 33) 
k=0
sm=0
