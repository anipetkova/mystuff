...
logreg=LogisticRegression(penalty='l2', max_iter=8000, class_weight='balanced')

#Kfold
kf = KFold(n_splits=24, shuffle = True, random_state = 93)#best: 93, 1:85,2:93 ###19 1:84, 2:92
k=0
sm=0
